"""Stack-aware `doctor` for awrouter.
...
interesting failures live BETWEEN them. "awrouter is installed" is not the useful
fact -- "awrouter is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrouter needs at runtime, and a
